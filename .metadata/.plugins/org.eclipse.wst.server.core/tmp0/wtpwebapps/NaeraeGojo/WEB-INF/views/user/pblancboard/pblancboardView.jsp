      ...
      <div class="col-md-11">
          <div class="box box-warning">
            <div class="box-header with-border">
              <b class="box-title">공고 상세 정보</b>
              <br/><br/>
            </div>
            <div class="box-body">
             <form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/user/pblancboard/updatePblancboard.do" method="post">
            	...
            	<div class="form-group">
	              	...
	              	<div class="col-sm-8">
	                	...
	                	id="pblanc_board_budget" name="pblanc_board_budget" value="${pblancboardInfo.pblanc_board_budget}">
	              	</div>
            	</div>

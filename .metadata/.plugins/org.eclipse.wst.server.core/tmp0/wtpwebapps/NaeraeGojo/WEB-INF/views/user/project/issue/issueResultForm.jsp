    ...
    <br/><br/>
      ...
      <div class="col-md-11">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
             <form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/user/project/issue/insertIssueResult.do" method="post">
				...
				<div class="form-group">
	              	...
	              	<div class="col-sm-3">
	                	...
	                	id="emp_code_ir" name="emp_code_ir" value="${LOGIN_EMPINFO.emp_name }">
	                	<input type="text" class="form-control" style="border-radius: 1em;" placeholder="담당자"
	                	value="${LOGIN_EMPINFO.emp_name }" readonly="readonly">
	              	</div>

             ...
             <form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/user/project/issue/updateIssue.do" method="post">
            	...
            	<div class="form-group">
	              	...
	              	<div class="col-sm-8">
	                	...
	                	id="issue_event_day" name="issue_event_day" value="">
	              	</div>
            	</div>
				...
				<div class="form-group">
	      			...
	      			id="issue_result_content" name="issue_result_content" value="">${issueInfo.issue_result_content}</textarea>
	   			</div>
	   			...
	   			<div class="form-group">
	              	...
	              	<div class="col-sm-3">
	                	...
	                	id="issue_result_day" name="issue_result_day" value="${issueInfo.issue_result_day}">
	              	</div>
				...
				<div class="form-group">
	              	...
	              	<div class="col-sm-3">
	                	...
	                	id="emp_code_ir" name="emp_code_ir" value="${issueInfo.emp_code_ir}">
	                	<input type="text" class="form-control" style="border-radius: 1em;" placeholder="담당자"
	                	value="${issueInfo.emp_code_ir}" readonly="readonly">
	              	</div>

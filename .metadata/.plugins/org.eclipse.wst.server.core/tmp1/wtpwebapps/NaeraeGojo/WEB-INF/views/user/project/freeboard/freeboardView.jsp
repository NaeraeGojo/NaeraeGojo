          ...
          <div class="box box-warning">
			...
			<!-- Left and right controls -->
				...
				<div class="box-footer clearfix">
              	...
              	<input value="수정" type="button" id="updateFB" class="btn btn-sm btn-danger btn-flat pull-right">
              	<input value="댓글" type="button" id="updateFB" class="btn btn-sm bg-maroon color-palette btn-flat pull-right">
          		</div>
		        </div>
            	</div>
          <!-- /.box -->
...
$(function(){
	$('#updateFB').click(function(){
		$(location).attr('href', '${pageContext.request.contextPath}/user/freeboard/freeboardUpdate.do');
	});
});
</script>
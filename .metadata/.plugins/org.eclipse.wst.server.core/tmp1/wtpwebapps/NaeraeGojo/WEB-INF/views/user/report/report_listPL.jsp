      ...
      <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">보낸 보고서함</a></li>
...
<!-- 			<option>검색조건</option> -->
	    ...
	    <button type="button" id="btn1" class="btn btn-info form-control"> + 보고서 등록</button>
		</form>
          </div>
              </div>
              <!-- /.tab-pane -->
...
// 	});
	$('#btn1').click(function(){
        $(location).attr('href', '${pageContext.request.contextPath}/user/report/report_sendInsertPL.do');
	})
	$('#btn2').click(function(){
        $(location).attr('href', '${pageContext.request.contextPath}/user/report/report_recViewPL.do');
	})

    $('#sendReport tr:gt(0)').click(function(){
//         var bo_no = $(this).find('td:eq(0)').text();
        $(location).attr('href', '${pageContext.request.contextPath}/user/report/report_sendDeletePL.do');
    });
    
    $('#recReport tr:gt(0)').click(function(){
        var bo_no = $(this).find('td:eq(0)').text();
        $(location).attr('href', '${pageContext.request.contextPath}/user/report/report_recViewPL.do');
    });
})

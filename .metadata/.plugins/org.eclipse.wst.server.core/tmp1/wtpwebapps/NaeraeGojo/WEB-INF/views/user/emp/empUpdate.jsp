               					...
               					<div class="col-md-7">
			                		...
			                		<div class="row">
			                			<label class="col-sm-3 control-label" style="margin-top: 3px;">전화번호</label>
		                  				<div class="col-sm-2">
		                  					<input type="hidden" name="emp_phone" value="${empInfo.emp_phone}" />
		                  					<select class="form-control" style="border-radius: 1em;" name="emp_ph1">
												...
												<option value="019" <c:if test = "${empInfo.emp_phone.split('-')[0] eq '019'}">selected </c:if>>017</option>				        	
		                  					</select>
			                  			</div>
		                  				...
		                  				<div class="col-sm-2">
			                  				<input type="text" name="emp_ph2" class="form-control" style="border-radius: 1em;" value="${empInfo.emp_phone.split('-')[1]}">
										</div>
										<div class="col-sm-1" style="margin:-10px; margin-right: -30px;">
			                  				<b style="font-size: 30px;">-</b>
			                  			</div>
			                  			<div class="col-sm-2">
				                  			<input type="text" name="emp_ph3" class="form-control" style="border-radius: 1em;" value="${empInfo.emp_phone.split('-')[2]}">
				                  		</div>
		                  			</div>
			                		<div class="row">
					                	<label class="col-sm-3 control-label" style="margin-top: 3px;">이메일</label>
					                		<input type="hidden" name="emp_email" value="${empInfo.emp_email}" />
										<div class="col-sm-3">
					                  		<input type="text" name="emp_email1" class="form-control" style="border-radius: 1em;" value="${empInfo.emp_email.split('@')[0]}">
										</div>
				                  		<div class="col-sm-1">
		                			...
		                			<div class="row">
				                		<label class="col-sm-3 control-label" style="margin-top: 3px;">부서</label>
				                  		<div class="col-sm-3">
				                  			<input type="hidden" name="part_code" value="${empInfo.part_code}" />
	                				...
	                				<div class="row">
                						<label class="col-sm-3 control-label" style="margin-top: 3px;">권한</label>
			                  			<div class="col-sm-3">
				                  			<input type="hidden" name="emp_role" value="${empInfo.emp_role}" />

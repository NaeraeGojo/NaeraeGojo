...
// 			alert(idPicFileName);
			$('#viewTable').html('<img src = "/image/' + idPicFileName + '" width = "200" height = "250" onclick = "popupClose();"/>');
				...
				<table width="300" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="38" background="${pageContext.request.contextPath }/image/open_tt.gif" align="center">
							<form id="idPicForm" action="${ pageContext.request.contextPath }/user/member/updateIdFileUpload.do" 

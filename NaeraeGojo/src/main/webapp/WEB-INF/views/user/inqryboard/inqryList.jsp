...
<!-- 			<option>검색조건</option> -->
	    ...
	    <button type="button" id="btn1" class="btn btn-info form-control"> + 문의 등록</button>
		</form>
...
$(function(){
	$('table tr:gt(0)').click(function(){
		...
		$(location).attr('href', '${pageContext.request.contextPath}/user/inqryboard/inqryView.do');
	});
	$('#btn1').click(function(){

      ...
      <div class="col-md-12">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <b class="box-title">자유게시판 댓글등록</b>
              <br/><br/>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">원 게시글 번호</label>
                  	<div class="col-sm-8">
                  		<input type="text" class="form-control" disabled="" style="border-radius: 1em;">
                	</div>                
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">원 게시글 제목</label>
                  <div class="col-sm-8">
                  	<input type="text" class="form-control" disabled="" style="border-radius: 1em;">
 	              </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                  	<textarea class="form-control" rows="10" placeholder="Enter ..." style="border-radius: 1em;"></textarea>
                  </div>
                </div>
                <div class="form-group">

	...
	<div class="col-md-12">
		...
		<div class="box box-2team">
			<div class="box-header with-border">
				<b class="box-title">제안 요청서 등록</b> <br />
				<br />
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<form role="form" id="rfpForm" class="form-horizontal"
					...
					<input type="hidden" name="mp_code"> <input type="hidden"
						name="emp_code" value="${LOGIN_EMPINFO.emp_code}">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="name" type="text" name="rqpps_name"
								class="form-control" style="border-radius: 1em;"
								placeholder="제안 요청서 명">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="writer" type="text" name="rqpps_nickname"
								class="form-control" style="border-radius: 1em;"
								value="${LOGIN_EMPINFO.emp_nick}" readonly="readonly">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="aname" type="text" name="rqpps_notice_agency"
								class="form-control" style="border-radius: 1em;"
								placeholder="공고기관 명">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input id="edate" type="date" name="rqpps_end_date"
								class="form-control" style="border-radius: 1em;"
								placeholder="제안서 마감">
						</div>
					</div>
					...
					<div class="form-group ">
						...
						<div class="col-md-1 " style="width: auto;">
							<div id="dres" hidden="hidden"
								style="margin-top: 10px; padding: 5px;"></div>
							<input id="btn_rp" type="button"
								class="bg-teal btn form-control btn-sm" data-toggle="modal"
								data-target="#modal-default" value="추가"
								style="border-radius: 1em;"> <input id="btn_rpre"
								type="button" class=" bg-teal btn form-control btn-sm"
								data-toggle="modal" data-target="#modal-update" value="수정"
								style="border-radius: 1em; display: none;">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input id="pr" type="text" name="rqpps_qualification"
								class="form-control" style="border-radius: 1em;"
								placeholder="참가 자격">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input id="pmoney" type="number" name="rqpps_budget"
								class="form-control" style="border-radius: 1em;" placeholder="￦">
						</div>
					</div>
					...
					<div class="form-group">
						<label for="contents" class="col-sm-2 control-label">요청서
							내용</label>
						<textarea id="contents" name="rqpps_contents" class="col-sm-10"
							rows="10" placeholder="요청서 내용"
							style="width: 68%; border: 1px solid #d2d2d2; border-radius: 1em;"></textarea>

					</div>

					<div class="form-group">
						<label for="file01" class="col-sm-2 control-label">제안요청서
							첨부</label>
						<div class="col-sm-10">
					...
					<div class="box-footer clearfix">
						<input value="등록" type="submit"
							href="${pageContext.request.contextPath}/user/meeting/meetingList.do"
				...
				<form id="ppForm">
					<table style="margin-left: 80px;">
						<tr>
							...
							<td><input name="mp_begin" type="number"
								class="form-control" style="border-radius: 1em; width: 50%;"
								value="0"></td>
						</tr>
						<tr>
							<td><label class="control-label">중급</label></td>
							<td><input name="mp_inter" type="number"
								class="form-control" style="border-radius: 1em; width: 50%;"
								value="0"></td>
						</tr>
						<tr>

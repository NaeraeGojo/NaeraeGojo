...
$(function(){
	$('#rfpForm').click(function(){
		$(location).attr('href','${pageContext.request.contextPath}/user/rfp/rfpForm.do');
	});
	...
	$('.a_view').click(function(){
		...
		$(this).attr('href','${pageContext.request.contextPath}/user/rfp/rfpView.do' + query)
...
.callout a:hover{
    ...
    <div class="rfpcont">
    	<div class="col-md-1"  style="float:right;">
	      <input id="rfpForm" value="+ 제안요청서 등록" type="button" class="btn btn-block bg-yellow btn-lg "  

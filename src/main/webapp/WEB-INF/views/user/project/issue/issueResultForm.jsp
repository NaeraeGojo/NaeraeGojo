...
$(function(){
	...
	$('#issueResultForm').submit(function(){
	...
	<div class="row">
		<div class="col-md-11">
			<div class="box box-warning">
				...
				<div class="box-body">
					<form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/user/project/issue/insertIssueResult.do" 
					method="post" id="issueResultForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" style="border-radius: 1em;" placeholder="이슈제목" id="issue_name"
								name="issue_name" value="${issueInfo.issue_name}" disabled="disabled">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" style="border-radius: 1em;" placeholder="작성자" id="emp_code1"
								name="emp_code1" value="${issueInfo.emp_code}" disabled="disabled">
							</div>
						</div>
						...
						<div class="form-group">
							...
							id="issue_result_content" name="issue_result_content"></textarea>
						</div>

						<div class="form-group">
							<label for="issue_result_day" class="col-sm-2 control-label">처리일자</label>
							<div class="col-sm-3">
								<input type="date" class="form-control" style="border-radius: 1em;" id="issue_result_day"
								name="issue_result_day">
							</div>

							<label for="emp_code_ir" class="col-sm-2 control-label">담당자</label>
							<div class="col-sm-3">
								<select class="form-control" style="border-radius: 0em;" name="emp_code_ir" id="emp_code_ir" disabled="disabled">
				...
				<div class="box-footer clearfix">
					...
					<button type="submit" id="insertBtn" class="btn btn-sm btn-warning btn-flat pull-right">처리 등록</button>
				</div>
				</form>
			</div>
		</div>

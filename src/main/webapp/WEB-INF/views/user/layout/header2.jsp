...
<header class="main-header">
    ...
    <!-- logo for regular state and mobile devices -->
     			<span class="logo-lg" style="font-size: 20px"><b>Protoss</b></span>
   			</a>
	...
	<!-- Notifications: style can be found in dropdown.less -->
          				<li class="dropdown notifications-menu">
            				<a href="${pageContext.request.contextPath}/user/join/bell.do">
	...
	<!-- Menu Footer-->
								<li class="user-footer">
                					...
                					<div class="pull-right">
                  						<a href="${pageContext.request.contextPath}/user/logout.do" class="btn btn-default btn-flat">Sign out</a>
               						</div>
								</li>
							</ul>
						</li>
